...
The model will train with ~2b tokens/20 100m-token segments (estimated 30 hours on my Laptop RTX 5070 Mobile), and after each epoch it will save the current model to `./artifacts/planckgpt.pth` and a checkpoint containing the model and training state in `.artifacts/checkpoints/`.
