...
class ChatBot(nn.Module):
    ...
    def train_model(
        ...
        for segment_index, segment in enumerate(data_loader):
            ...
            tokens = torch.from_numpy(np.array(self.text_to_tokens(segment), dtype=np.int64))
            ...
            for batch_start in range(0, len(sequences), batch_size):
                ...
                batch_sequences = sequences[batch_start:batch_start + batch_size].to(self.device)
